  ...
  return (
    <div className="space-y-4">
      <header>
        ...
        <p className="text-sm text-ink2">Retrospectivas semanais escritas pelo agente.</p>
      </header>
      ...
      {retros !== null && retros.length === 0 && (
        <div className="rounded-2xl border border-hairline bg-surface p-5 text-center">
          <p className="text-sm text-ink2">
            A primeira retrospectiva será escrita no domingo, analisando os registros da semana.
          </p>
